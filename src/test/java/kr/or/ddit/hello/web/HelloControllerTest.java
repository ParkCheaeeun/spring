...
public class HelloControllerTest {
	...
	//server(tomcat)가 없는 환경에서 테스트 가능
	@Test
	public void helloTest() throws Exception {
		...
		//controller viewName(String)을 리턴하지만, 스프링 프레임워크 내부에서는 viewName을 ModelAndView객체로 변환해서 사용
		//또한 컨트롤러 메소드에서는 viewName 뿐만 아니라 ModelAndView 객체, View객체 리턴하는게 가능
		//리턴타입이 void인 경우도 존재(response 객체를 통해 개발자가 직접 응답을 생성하는 것이 가능)
